...
console.log(chalk.bold.white.bgMagenta(' Hello '+userName+'!  Welcome to Game of Thrones Quiz! '));
console.log('\n');

console.log(chalk.italic.bgRed("Rules:")+("\n1. Use the correct input type (a,b,c) then click enter.\n2. You need to score > 3 to reach second level and >7 to third level. "));
...
var questionSet = [
  ...
  {
    question:"Name the season in which Jon Snow died.\na. Season 6\nb. Season 5\nc. Season 4\n",
    answer:"b",
  },
  {
    question:"_____ is the biggest castle in the Westeros.\na. Casterly Rock\nb. Highgarden\nc. Harrenhal\n",
    answer:"c",
  },
  {
    question:"Episode \"Red Wedding\" is in ?\na. Season 4\nb. Season 3\nc. Season 2\n",
    answer:"b",
  },
  {
  ...
  {
    question:"‘The Viper’ is the nickname of whom?\na. Ellaria Sand\nb. Ella Sand\nc. Oberyn Martell",
    answer:"c"
  },
  {
    question:"Daenerys legitimized Gendry Baratheon and made him Lord of _____.\na. Dragon Stone\nb. Stormland\nc. Highgarden",
    answer:"b",
  },
  {
    question:"Which character is also known as the ‘Onion Knight’?\na. Bronn\nb. Brienne\nc. Ser Davos",
    answer:"c",
  },
  {
  ...
  {
    question:"How many kings/queens of Westeros did Lord Varys serve?\na. 4\nb. 3\nc. 5",
    answer:"a",
  },
  {
    question:"How was \"The Queen of Thorns\" commonly known as?\na. Margery Tyrell\nb. Olenna Tyrell\nc. Cersie Lannister",
    answer:"b",
  },
  {
    question:"What does Daenerys mean when she says \"Shekh ma shieraki anni\"\na. Moon of my life\nb. My love\nc. My sun and stars",
    answer:"c",
  }
]
...
console.log(chalk.greenBright("Your final score is "+score+" out of "+questionSet.length));
console.log("\n");

if(score==questionSet.length){
  console.log(chalk.bgMagenta.bold("BRAVO !!! YOU KNOW EVERYTHING !!! HATS OFF TO YOU BUDDY !!!"));
    console.log("\n");
}
